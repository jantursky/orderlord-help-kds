...
- [Prepare the order]({{site.baseurl}}{% link docs/getting-started/prepare-the-order.md %})
- [Finish the order]({{site.baseurl}}{% link docs/getting-started/finish-the-order.md %})
- [Reset the order]({{site.baseurl}}{% link docs/getting-started/reset-the-order.md %})
- [Cancel the order]({{site.baseurl}}{% link docs/getting-started/cancel-the-order.md %})
